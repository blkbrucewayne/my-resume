...
const projects = [
  ...
  {
    title: 'Enterprise Training Initiative',
    subtitle: 'Data Systems Engineer',
    duration: '2017-2018',
    status: 'past',
    highlights: [
      'Designed and implemented IT training programs for over 120 personnel.',
      'Achieved a 35% boost in workforce technical capabilities.',
